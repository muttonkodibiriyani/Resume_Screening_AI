...
export const BENCHMARK_TEMPLATES: BenchmarkTemplate[] = [
  {
    ...
    primarySkills: [
      ...
      'Oracle Fusion Middleware (SOA Suite, OSB)',
      'Automic Automation',
      'PL/SQL (advanced)',
      'EDI (EDIFACT/X12/AS2)',
    ],
    mandatorySkills: [
      'ODI Knowledge Modules customization',
      'OIC adapters & integrations',
      'PL/SQL packages, performance tuning',
      'Automic enterprise scheduling',
    ...
    technicalDepthIndicators: [
      'Designed hub-and-spoke / canonical patterns',
      'PL/SQL tuning (execution plans, partitioning, bulk ops)',
      'Custom KMs',
      'Reusable integration libraries',
      'Error handling frameworks',
    ],
    functionalDomainIndicators: [
      'Retail integration (POS, Merchandising, Finance)',
    ...
    leadershipExpectations: [
      'Led team of 8+ integration developers',
      'Vendor management',
      'Stakeholder workshops',
      'Mentoring & code review standards',
    ],
    deliveryExpectations: [
      '2+ full-lifecycle integration platforms',
      'Production go-lives at enterprise scale',
      'SLA-bound integration operations',
      'Performance benchmarks',
    ],
    modernizationExpectations: [
      'On-prem to OIC migration',
      'CI/CD pipelines (Git, Jenkins/ADO)',
      'Observability (App Insights, Splunk)',
      'API-first redesign',
    ],
    redFlags: [
      '"Architect" without HLD/LLD evidence',
      'Only ODI mapping work without governance',
      'No EDI/B2B exposure for retail',
      'Skill stacking without project depth',
    ...
    idealSummary:
      '15+ year senior integration architect with deep ODI/OIC/OFMW mastery, PL/SQL tuning, Automic orchestration, EDI gateway design, and proven enterprise go-lives.',
  ...
  },
  {
    ...
    mandatorySkills: [
      'End-to-end iPaaS design',
      'APIM policies',
      'Hybrid connectivity (On-Prem Data Gateway, Private Endpoints)',
      'DevOps for integration (Bicep/Terraform)',
      'Azure security (Managed Identity, Key Vault)',
    ],
    goodToHaveSkills: [
      'Event-driven & saga patterns',
      'GitHub Actions / ADO pipelines',
      'App Insights & Log Analytics',
      'FinOps for integration',
      'AZ-305 / AZ-400 certifications',
    ],
    technicalDepthIndicators: [
      'Enterprise Integration Patterns (EIP)',
      'Async/sync hybrid orchestration',
      'OAuth2 / mTLS',
      'Network isolation',
      'Performance & cost optimization',
    ],
    functionalDomainIndicators: [
      'Retail order/inventory/finance integration',
    ...
    leadershipExpectations: [
      'Led 10+ Azure integration engineers',
    ...
    modernizationExpectations: [
      'IaC (Bicep/Terraform)',
      'CI/CD for Logic Apps/APIM',
      'Observability',
      'Event-driven modernization',
      'API-first design',
    ],
    redFlags: [
      'No production Azure Logic Apps/APIM',
      'No IaC experience',
      'Azure cert without project depth',
      'Skill stacking',
      'No cost-management awareness',
    ],
    weights: DEFAULT_WEIGHTS,
    interviewQuestions: [
    ...
    idealSummary:
      'Senior Azure integration architect with deep Logic Apps/APIM/Service Bus mastery, IaC fluency, security-first design, and proven multi-region iPaaS delivery.',
    screeningNotes: [
      'Validate APIM policy depth',
      'Ask for cost optimization examples',
      'Probe security & network design',
    ],
  },
  {
    ...
    primarySkills: [
      'Oracle EBS Finance (GL, AP, AR, FA, CM, EBTax)',
      'Oracle EBS HR (Core HR, Payroll, SSHR, OAB, OLM)',
      'Chart of Accounts design',
      'Multi-org, multi-currency',
      'Period close & statutory compliance',
    ],
    mandatorySkills: [
      'Full-cycle EBS implementations',
      'CRP/UAT leadership',
      'Statutory compliance per geography',
      'Payroll element design',
      'Reporting (FSG, BI Publisher)',
    ],
    goodToHaveSkills: [
      'Oracle Fusion / Cloud roadmap',
      'EBS-to-Fusion migration awareness',
      'Tax engine (Vertex, Sabrix)',
      'SQL for reporting',
    ],
    technicalDepthIndicators: [
      'Period-close runbook ownership',
      'Multi-currency revaluation',
      'Subledger Accounting (SLA) setup',
      'Payroll element catalog',
    ],
    functionalDomainIndicators: [
      'Retail-specific finance flows',
      'GCC/India/EU statutory expertise',
      'IFRS/local GAAP',
    ],
    architectureExpectations: [
      'Solution blueprint ownership',
      'COA strategy',
      'Data migration design',
      'Integration touchpoints documented',
    ],
    leadershipExpectations: [
      'Led 2+ EBS implementations',
      'Workshops with CFO/CHRO stakeholders',
      'Vendor coordination',
    ],
    deliveryExpectations: [
      'Full-lifecycle implementations',
      'Go-live ownership',
      'Hyper-care management',
      'Measurable close-cycle reduction',
    ],
    modernizationExpectations: [
      'EBS to Oracle Fusion migration awareness',
      'Coexistence strategy',
      'Cloud reporting (OAC)',
    ],
    redFlags: [
      'EBS claimed but no period-close pain points articulated',
      'HR module claimed without payroll depth',
      'Only support/AMS without implementation',
    ...
    idealSummary:
      'Senior EBS Finance + HR functional architect with multi-country statutory depth, full-lifecycle implementations, and migration-path awareness.',
    screeningNotes: [
      'Probe period-close depth',
      'Validate payroll element design',
      'Ask for specific country statutory experience',
    ],
  },
  {
    ...
    mandatorySkills: [
      'Item / merchandise hierarchy design',
      'Stock ledger reconciliation',
      'Costing (markup/markdown)',
      'Promotions',
    ...
    goodToHaveSkills: [
      ...
      'BDI',
      'Oracle Retail Cloud (RMFCS) migration',
    ],
    technicalDepthIndicators: ['RMS data model fluency', 'Reconciliation runbooks', 'PL/SQL for retail reports'],
    functionalDomainIndicators: [
      'Apparel / grocery / electronics retail depth',
      'Multi-format retail',
      'Franchise vs owned',
    ],
    architectureExpectations: [
      'Solution blueprint for RMS rollout',
      'Integration touchpoints (RIB/BDI/OIC)',
      'Data migration design',
    ],
    leadershipExpectations: [
      'Led 2+ RMS implementations',
      'CRP/UAT facilitation',
      'Workshops with merchandising heads',
    ],
    deliveryExpectations: [
      'Full-lifecycle RMS implementations',
      'Specific retailer references',
      'Stock ledger sign-off',
    ],
    modernizationExpectations: [
      'RMS → RMFCS cloud migration',
      'OIC/ICS for retail integration',
      'Modern POS integration',
    ],
    redFlags: [
      'RMS claimed without retailer names',
      'No stock ledger experience',
      'Only RPM or only SIM without core RMS',
      'No retail business depth',
    ],
    weights: DEFAULT_WEIGHTS,
    interviewQuestions: [
    ...
    idealSummary:
      'Senior Oracle RMS architect with proven Tier-1 retail implementations, stock ledger and merchandising hierarchy depth, and cloud-migration awareness.',
  ...
  },
  {
    ...
    architectureExpectations: [
      ...
      'Micro-frontend mobile patterns',
      'Security (cert pinning, biometric)',
    ],
    ...
    redFlags: [
      'Web React experience repackaged as React Native',
      'No store-published apps',
      'No native module experience',
    ...
    idealSummary:
      'Senior React Native architect with deep TS, native bridge fluency, production apps at scale, and modern CI/CD ownership.',
  ...
  },
  {
    ...
    primarySkills: [
      'JavaScript (ES2022+)',
      'TypeScript',
      'React 18+ (Concurrent, Suspense, RSC)',
      'Next.js / Remix',
    ...
    redFlags: [
      'Only feature coding without architecture',
      'No accessibility evidence',
      'No perf metrics',
      'No design system ownership',
    ],
    weights: DEFAULT_WEIGHTS,
    interviewQuestions: [
    ...
    idealSummary:
      'Senior frontend architect with design-system ownership, Core Web Vitals mastery, accessibility discipline, and modern React (RSC) fluency.',
  ...
  },
  {
    ...
    idealSummary:
      'APEX architect replacing legacy systems at enterprise scale with secure, performant, integrated apps and DevOps maturity.',
  ...
  },
  {
    ...
    mandatorySkills: [
      ...
      'MLOps (MLflow, Kubeflow, Vertex AI / Azure ML)',
    ...
    idealSummary:
      'Senior Python/ML architect with production GenAI/RAG, MLOps fluency, and measurable business outcomes — 2026-ready.',
  ...
  },
  {
    ...
    deliveryExpectations: [
      '2+ PimCore implementations at enterprise scale',
      '10K+ SKUs',
      '1+ omnichannel publishing setup',
    ],
    ...
    idealSummary:
      'PimCore architect with deep data modeling, omnichannel publishing, and enterprise-scale delivery at retailers.',
  ...
  },
  {
    ...
    idealSummary:
      'Senior data analyst with retail KPI fluency, advanced SQL, BI tool mastery, and storytelling that drives decisions.',
  ...
  },
  {
    ...
    idealSummary:
      'Hands-on technical lead with full-stack fluency, proven team leadership, and production delivery discipline.',
