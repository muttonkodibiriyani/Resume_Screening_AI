...
describe('normalizeAIScore', () => {
    ...
    const r = normalizeAIScore(
      {
        overallScore: 200,
        breakdown: {
          years: 99, primarySkillDepth: 99, architectureArtifacts: 99, projectFootprint: 99,
          leadership: 99, modernization: 99, certifications: 99, communication: 99,
        },
      },
      bench,
      'X',
  ...
  it('keeps AI overall when within 5 points of sum', () => {
    const r = normalizeAIScore(
      {
        overallScore: 60,
        breakdown: { years: 5, primarySkillDepth: 15, architectureArtifacts: 10, projectFootprint: 10, leadership: 5, modernization: 5, certifications: 3, communication: 3 },
      },
      bench,
      'X',
    );
  ...
  it('assigns score band from overall', () => {
    const r = normalizeAIScore(
      {
        overallScore: 92,
        breakdown: { years: 10, primarySkillDepth: 25, architectureArtifacts: 20, projectFootprint: 15, leadership: 10, modernization: 10, certifications: 5, communication: 5 },
      },
      bench,
      'X',
    );
